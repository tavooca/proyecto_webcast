...
response.menu += [
    (T('Grupos'), False, URL('configuracion','grupos'), [])
    ]
    
response.menu += [
    (T('Estados'), False, URL('configuracion','estados'), [])
    ]
    
response.menu += [
    (T('Tipos'), False, URL('configuracion','tipos'), [])
    ]


response.menu += [
    (T('Clientes'), False, URL('configuracion','clientes'), [])
    ]
    
    
response.menu += [
    (T('proyectos'), False, URL('configuracion','proyectos'), [])
    ]


response.menu += [
    (T('Tareas'), False, URL('configuracion','tareas'), [])
    ]
#########################################################################
